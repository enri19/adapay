...
class WebhookController extends Controller
{
  ...
  private function validateDanaSignature(array $payload, string $orderId): bool
  {
    $signature = (string)($payload['signature_key'] ?? '');
    $expectedSignature = hash('sha512', $orderId . $payload['status_code'] . $payload['gross_amount'] . config('dana.server_key'));
